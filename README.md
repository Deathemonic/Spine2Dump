...
# Hide slots or attachments by name while dumping
spine2dump dump ./assets -o ./output --animation idle --hide background --hide bg_*
...
| `--hide <pattern>`            | Hide matching slot or attachment names; repeatable, supports `*` wildcard |                              |
